...
rejects("unbounded memory growth", mod(TYPE_SEC, MEM_UNBOUNDED, GOOD_EXPORTS), "over the 4096-page limit");
...
// --- positive case ---------------------------------------------------------
console.log("\npositive case:");
const real = process.argv[2] ?? "target/wasm32-unknown-unknown/release/smw_restool.wasm";
try {
